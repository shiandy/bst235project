...
selected_betas[coef == "beta6", ratio := value / -0.3]
selected_betas[coef == "beta7", ratio := value / -0.1]
selected_betas[coef == "beta8", ratio := value / 0.1]
selected_betas[coef == "beta9", ratio := value / 0.3]
